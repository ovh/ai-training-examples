...
> **Note** Access to the full documentation [here](https://docs.ovh.com/gb/en/publiccloud/ai/deploy/tuto-fastapi-spam-classifier/).
...
![Overview](images/overview-spam-classifier.png)
...
![Overview](images/get-method-fastapi.png)
...
![Overview](images/docs-fastapi.png)
...
![Overview](images/post-method-fastapi.png)

To get the result of the prediction, click on the `Execute` button.

![Overview](images/prediction-message-fastapi.png)
