...
> **Note** Note Access to the full documentation [here](https://docs.ovh.com/gb/en/publiccloud/ai/deploy/tuto-streamlit-sounds-classification/).
...
![Overview](images/overview-streamlit-sounds.png)
