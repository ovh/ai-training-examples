...
> **Note** Access to the full documentation [here](https://docs.ovh.com/gb/en/publiccloud/ai/deploy/getting-started/).
...
![AI Deploy app subscribe](images/ai_app_subscribe.png)
...
![AI Deploy app label](images/ai_app_labels.png)
...
![AI Deploy app details](images/ai_app_details.png)
...
![AI Deploy app details](images/ai_app_token.png)
...
![AI Deploy app details](images/ai_app_stop.png)
